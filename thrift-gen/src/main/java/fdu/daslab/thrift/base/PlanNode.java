            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputNodeId = new java.util.ArrayList<java.lang.Integer>(_list28.size);
                int _elem29;
                for (int _i30 = 0; _i30 < _list28.size; ++_i30)
                {
                  _elem29 = iprot.readI32();
                  struct.inputNodeId.add(_elem29);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputNodeId = new java.util.ArrayList<java.lang.Integer>(_list31.size);
                int _elem32;
                for (int _i33 = 0; _i33 < _list31.size; ++_i33)
                {
                  _elem32 = iprot.readI32();
                  struct.outputNodeId.add(_elem32);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PlanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.inputNodeId != null) {
        oprot.writeFieldBegin(INPUT_NODE_ID_FIELD_DESC);
        {
          ...
          for (int _iter34 : struct.inputNodeId)
          {
      ...
      if (struct.outputNodeId != null) {
        oprot.writeFieldBegin(OUTPUT_NODE_ID_FIELD_DESC);
        {
          ...
          for (int _iter35 : struct.outputNodeId)
          {
      ...
      if (struct.isSetInputNodeId()) {
        {
          ...
          for (int _iter36 : struct.inputNodeId)
          {
      ...
      if (struct.isSetOutputNodeId()) {
        {
          ...
          for (int _iter37 : struct.outputNodeId)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.inputNodeId = new java.util.ArrayList<java.lang.Integer>(_list38.size);
          int _elem39;
          for (int _i40 = 0; _i40 < _list38.size; ++_i40)
          {
            _elem39 = iprot.readI32();
            struct.inputNodeId.add(_elem39);
          }
        }
        struct.setInputNodeIdIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.outputNodeId = new java.util.ArrayList<java.lang.Integer>(_list41.size);
          int _elem42;
          for (int _i43 = 0; _i43 < _list41.size; ++_i43)
          {
            _elem42 = iprot.readI32();
            struct.outputNodeId.add(_elem42);
          }
        }
        struct.setOutputNodeIdIsSet(true);
      }
