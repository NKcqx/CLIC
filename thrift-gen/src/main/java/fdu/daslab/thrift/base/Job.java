...
public class Job implements org.apache.thrift.TBase<Job, Job._Fields>, java.io.Serializable, Cloneable, Comparable<Job> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map78.size);
                int _key79;
                @org.apache.thrift.annotation.Nullable Stage _val80;
                for (int _i81 = 0; _i81 < _map78.size; ++_i81)
                {
                  _key79 = iprot.readI32();
                  _val80 = new Stage();
                  _val80.read(iprot);
                  struct.subplans.put(_key79, _val80);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list82.size);
                int _elem83;
                for (int _i84 = 0; _i84 < _list82.size; ++_i84)
                {
                  _elem83 = iprot.readI32();
                  struct.sourceStages.add(_elem83);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map85.size);
                ...
                for (int _i88 = 0; _i88 < _map85.size; ++_i88)
                {
                  ...
                  struct.others.put(_key86, _val87);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Job struct) throws org.apache.thrift.TException {
      ...
      if (struct.subplans != null) {
        oprot.writeFieldBegin(SUBPLANS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter89 : struct.subplans.entrySet())
          {
      ...
      if (struct.sourceStages != null) {
        oprot.writeFieldBegin(SOURCE_STAGES_FIELD_DESC);
        {
          ...
          for (int _iter90 : struct.sourceStages)
          {
      ...
      if (struct.others != null) {
        oprot.writeFieldBegin(OTHERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter91 : struct.others.entrySet())
          {
  ...
  private static class JobTupleScheme extends org.apache.thrift.scheme.TupleScheme<Job> {
      ...
      if (struct.isSetSubplans()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter92 : struct.subplans.entrySet())
          {
      ...
      if (struct.isSetSourceStages()) {
        {
          ...
          for (int _iter93 : struct.sourceStages)
          {
      ...
      if (struct.isSetOthers()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter94 : struct.others.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Job struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map95 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map95.size);
          int _key96;
          @org.apache.thrift.annotation.Nullable Stage _val97;
          for (int _i98 = 0; _i98 < _map95.size; ++_i98)
          {
            _key96 = iprot.readI32();
            _val97 = new Stage();
            _val97.read(iprot);
            struct.subplans.put(_key96, _val97);
          }
        }
        struct.setSubplansIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list99.size);
          int _elem100;
          for (int _i101 = 0; _i101 < _list99.size; ++_i101)
          {
            _elem100 = iprot.readI32();
            struct.sourceStages.add(_elem100);
          }
        }
        struct.setSourceStagesIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map102.size);
          ...
          for (int _i105 = 0; _i105 < _map102.size; ++_i105)
          {
            ...
            struct.others.put(_key103, _val104);
          }
        }
        struct.setOthersIsSet(true);
      }
