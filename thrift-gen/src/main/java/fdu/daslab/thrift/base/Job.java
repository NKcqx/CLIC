...
public class Job implements org.apache.thrift.TBase<Job, Job._Fields>, java.io.Serializable, Cloneable, Comparable<Job> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map94.size);
                int _key95;
                @org.apache.thrift.annotation.Nullable Stage _val96;
                for (int _i97 = 0; _i97 < _map94.size; ++_i97)
                {
                  _key95 = iprot.readI32();
                  _val96 = new Stage();
                  _val96.read(iprot);
                  struct.subplans.put(_key95, _val96);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list98.size);
                int _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = iprot.readI32();
                  struct.sourceStages.add(_elem99);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map101.size);
                ...
                for (int _i104 = 0; _i104 < _map101.size; ++_i104)
                {
                  ...
                  struct.others.put(_key102, _val103);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Job struct) throws org.apache.thrift.TException {
      ...
      if (struct.subplans != null) {
        oprot.writeFieldBegin(SUBPLANS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter105 : struct.subplans.entrySet())
          {
      ...
      if (struct.sourceStages != null) {
        oprot.writeFieldBegin(SOURCE_STAGES_FIELD_DESC);
        {
          ...
          for (int _iter106 : struct.sourceStages)
          {
      ...
      if (struct.others != null) {
        oprot.writeFieldBegin(OTHERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter107 : struct.others.entrySet())
          {
  ...
  private static class JobTupleScheme extends org.apache.thrift.scheme.TupleScheme<Job> {
      ...
      if (struct.isSetSubplans()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter108 : struct.subplans.entrySet())
          {
      ...
      if (struct.isSetSourceStages()) {
        {
          ...
          for (int _iter109 : struct.sourceStages)
          {
      ...
      if (struct.isSetOthers()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter110 : struct.others.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Job struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map111 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map111.size);
          int _key112;
          @org.apache.thrift.annotation.Nullable Stage _val113;
          for (int _i114 = 0; _i114 < _map111.size; ++_i114)
          {
            _key112 = iprot.readI32();
            _val113 = new Stage();
            _val113.read(iprot);
            struct.subplans.put(_key112, _val113);
          }
        }
        struct.setSubplansIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list115.size);
          int _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = iprot.readI32();
            struct.sourceStages.add(_elem116);
          }
        }
        struct.setSourceStagesIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map118.size);
          ...
          for (int _i121 = 0; _i121 < _map118.size; ++_i121)
          {
            ...
            struct.others.put(_key119, _val120);
          }
        }
        struct.setOthersIsSet(true);
      }
