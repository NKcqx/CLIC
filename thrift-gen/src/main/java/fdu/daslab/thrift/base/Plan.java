    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Plan struct) throws org.apache.thrift.TException {
      ...
      if (struct.nodes != null) {
        oprot.writeFieldBegin(NODES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, PlanNode> _iter67 : struct.nodes.entrySet())
          {
      ...
      if (struct.sourceNodes != null) {
        oprot.writeFieldBegin(SOURCE_NODES_FIELD_DESC);
        {
          ...
          for (int _iter68 : struct.sourceNodes)
          {
      ...
      if (struct.isSetNodes()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, PlanNode> _iter69 : struct.nodes.entrySet())
          {
      ...
      if (struct.isSetSourceNodes()) {
        {
          ...
          for (int _iter70 : struct.sourceNodes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nodes = new java.util.HashMap<java.lang.Integer,PlanNode>(2*_map71.size);
          int _key72;
          @org.apache.thrift.annotation.Nullable PlanNode _val73;
          for (int _i74 = 0; _i74 < _map71.size; ++_i74)
          {
            _key72 = iprot.readI32();
            _val73 = new PlanNode();
            _val73.read(iprot);
            struct.nodes.put(_key72, _val73);
          }
        }
        struct.setNodesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.sourceNodes = new java.util.ArrayList<java.lang.Integer>(_list75.size);
          int _elem76;
          for (int _i77 = 0; _i77 < _list75.size; ++_i77)
          {
            _elem76 = iprot.readI32();
            struct.sourceNodes.add(_elem76);
          }
        }
        struct.setSourceNodesIsSet(true);
      }
