package edu.daslab.executable.java;

import edu.daslab.executable.basic.model.BasicOperator;
import edu.daslab.executable.basic.model.FunctionModel;
import edu.daslab.executable.java.constants.JavaOperatorEnums;
import edu.daslab.executable.basic.model.ParamsModel;
import edu.daslab.executable.java.model.StreamResult;
import edu.daslab.executable.basic.utils.ArgsUtil;
...
/**
 * Java平台的operator的具体实现，兼顾算子融合，因为是线性，只支持线性的合并，不支持 n - 1 ===> 依赖前面的pipeline同步，不依赖具体执行
 *
