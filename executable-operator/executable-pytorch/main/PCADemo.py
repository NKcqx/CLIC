...
if __name__ == "__main__":
    ...
    source = Factory.createOperator("PdCsvSource", RandomID(), [], ["result"],
                                    {"inputPath": "/Users/zjchen/PycharmProjects/Pytorch/hotel_bookings/hotel_bookings.csv"})
    ...
    tensorConverter = Factory.createOperator("TensorConverter", RandomID(), ["data"], ["result"], {"dtype": "float"})
