...
public class NotifyService {
  ...
  public interface Iface {
    ...
    public void postStatus(String jobName, int stageId, StageSnapshot stageSnapShot) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void postStatus(String jobName, int stageId, StageSnapshot stageSnapShot, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_postStatus(String jobName, int stageId, StageSnapshot stageSnapShot) throws org.apache.thrift.TException
    {
  ...
  public static class postStatus_args implements org.apache.thrift.TBase<postStatus_args, postStatus_args._Fields>, java.io.Serializable, Cloneable, Comparable<postStatus_args>   {
    ...
    public postStatus_args setJobName(@org.apache.thrift.annotation.Nullable String jobName) {
      this.jobName = jobName;
      return this;
    }
    ...
    public int compareTo(postStatus_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetStageSnapShot()).compareTo(other.isSetStageSnapShot());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetStageSnapShot()) {
