...
public class TransParams implements org.apache.thrift.TBase<TransParams, TransParams._Fields>, java.io.Serializable, Cloneable, Comparable<TransParams> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> others; // optional
  ...
  public TransParams setLocation(@org.apache.thrift.annotation.Nullable java.lang.String location) {
    this.location = location;
    return this;
  }
  ...
  public TransParams setOthers(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> others) {
    this.others = others;
    return this;
  }
  ...
  public int compareTo(TransParams other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTransType()).compareTo(other.isSetTransType());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TransParams(");
    boolean first = true;
