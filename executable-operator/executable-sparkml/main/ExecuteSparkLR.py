...
if __name__ == "__main__":
    ...
    source_train = factory.createOperator("SparkReadCSV", RandID(), [], ["result"],
                                          {"inputPath": r"E:\Project\CLIC_ML\data\Data_HousePrice\train.csv",
                                           "header": True,
                                           "infer_schema": True,
                                           "nan_value": "NA"})
    ...
    # 标准化
    standard = factory.createOperator("SparkStandardScaler", RandID(), ["data"], ["result"],
    ...
    assembler = factory.createOperator("SparkVectorAssembler", RandID(), ["data"], ["result"],
                                       {"input_cols": cols, "output_col": "features", "handle_invalid": "keep"})
