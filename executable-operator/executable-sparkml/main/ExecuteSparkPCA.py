...
if __name__ == "__main__":
    ...
    # 提取部分dataframe
    df_part = factory.createOperator("DataframeLimit", RandID(), ["data"], ["result"], {"number": 10})

    # 标准化
    standard_scaler = factory.createOperator("SparkStandardScaler", RandID(), ["data"], ["result"], {"cols": cols})
    ...
    pca = factory.createOperator("SparkPCA", RandID(), ["data"], ["result"],
                                 {"k": 10, "output_col": "PCA_res", "cols": cols})
