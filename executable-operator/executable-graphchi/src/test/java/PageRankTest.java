...
//        pa.put("inputPath", filePath1);
//        List<String> in1 = new LinkedList<String>();
//        in1.add("data");
//        List<String> out1 = new LinkedList<String>();
//        out1.add("result");
//        FileSourceOperator fileSourceOperator = new FileSourceOperator("1", in1, out1, pa);
//        fileSourceOperator.execute(null,null);
//        InputStream inputStream = fileSourceOperator.getOutputData("result");
//
