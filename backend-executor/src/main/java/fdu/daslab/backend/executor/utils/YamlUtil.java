...
public class YamlUtil {
    ...
    private static String argoDag=System.getProperty("user.dir") +"/backend-executor/src/main/resources/templates/argo-dag-simple.yaml";
    private static String javaTemplate=System.getProperty("user.dir") +"/backend-executor/src/main/resources/templates/java-template.yaml";
    private static String sparkTemplate=System.getProperty("user.dir") +"/backend-executor/src/main/resources/templates/spark-template.yaml";
    ...
    public Map joinTask(ArgoNode node){
        ...
        if(node.getTemplate().equals("java")){
            parameterStr+="java -jar xxx.jar ";//java运行封装好的jar
        }
