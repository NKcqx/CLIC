...
public class FieldName {
    ...
    public final static String STAGE_PLATFORM = "platform";
    public final static String STAGE_PARENT_LIST = "parent_list";
    public final static String STAGE_CHILDREN_LIST = "children_list";
    public final static String STAGE_START_TIME = "start_time";
